...
foreach ($dbc->query($req) as $row) {
    if ($login == $row['email'] && $pwd == $row['password']) {
        $_SESSION['connect'] = 1;
...
<html>
    ...
    <body id="page-top" class="index">
        ...
        <div class="portfolio-modal modal fade" id="portfolioModal1" tabindex="-1" role="dialog" aria-hidden="true">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="login-form">
                                    <form method="POST" action="index.php">
                                        ...
                                        <br /><br />
                                        <input title="login" type="submit" value="submit" />
                                        <br /><br />
            ...
            echo $nom;
        } ?>" type="text" class="form-control" id="nom" name="nom" placeholder="name">
                                                        </div>
<?php if (!empty($erreur['nom'])) { ?>
                                                                <div id="erreur" class="col-sm-5" class="alert alert-danger" role="alert">
                                                                    <span class="glyphicon glyphicon-exclamation-sign" aria-hidden="true"></span>
                                                                    <span class="sr-only">Error:</span>
    <?php echo $erreur['nom']; ?>  </div>  <?php } ?>
                                                    </div>
                                    
                                       <div class="form-group">                    
                                                        <label for="First name" class="col-sm-2 control-label">Nom :</label>
                                                        <div class="col-sm-5">
                                                             <input  value="<?php if (isset($fnom)) {
    echo $fnom;
} ?>" type="text" class="form-control" id="fnom" name="fnom" placeholder="first name">
                                                        </div>
                                    <?php if (!empty($erreur['fnom'])) { ?>
                                                                <div id="erreur" class="col-sm-5" class="alert alert-danger" role="alert">
                                                                    <span class="glyphicon glyphicon-exclamation-sign" aria-hidden="true"></span>
                                                                    <span class="sr-only">Error:</span>
    <?php echo $erreur['fnom']; ?>  </div>  <?php } ?>
                                                    </div>
    ...
    <?php echo $erreur['pwd']; ?>
                                    ...
                                    <?php } ?>
                                                            ...
                                                            <div class="form-group">                    
                                                        <label for="pwd" class="col-sm-2 control-label">Confirmation Mot de passe :</label>
                                                        <div class="col-sm-5">
